...
<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
  ...
  function sendIt(){
		...
		f.action = "<%=cp%>/itmall/created_ok.do";
		f.submit();
...
//새창 만들기
	function idCheck(){
	  ...
	  window.open("<%=cp%>/itmall/idCheckForm.do", "idwin", "width=400, height=350");
 ...
 <form action="" method="post" name="myForm" > 
  ...
  <article class="join-us">
    ...
    <div class="content-box">
      ...
      <p class="essential">아이디</p>
      <div>
        <input type="text" placeholder="ex : cjone12" name="userId" readonly="readonly">
        <button class="black-btn" onclick="idCheck();" >중복확인</button>
      </div>
      ...
      <div>
        <input type="password" placeholder="비밀번호를 한번 더 입력해주세요" name="userPwd2">
      </div>
      ...
      <div>
        <input type="hidden" placeholder="숫자만 입력해주세요"  name="">
      </div>
      
      <p class="essential">휴대전화</p>
      <div>
        <input type="tel" placeholder="숫자만 입력해주세요"  name="userTel">
      </div>
     ...
     <p>주소</p>
      ...
      <div class="agree">
        <p ></p>
        <div class="checkbox_group"></div>

       <button class="black-btn" onclick="sendIt();">가입하기</button>
